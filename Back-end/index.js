...
const { startCronJob, singleSend } = require("./utils/cronService");
...
<html>
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    ...
    <p>
      I am applying for the <strong>${job?.job} Developer</strong> role. With
...
app.delete("/delete-job", async (req, res) => {
    ...
    try {
        ...
        res.status(500).send({ error: "Failed to start send-mail-single." });
    }
});
  ...
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    ...
    <p>
      ...
      +91 8532083765
        ...
        res.status(500).send({ error: "Failed to send emails to all jobs." });
    }
});
