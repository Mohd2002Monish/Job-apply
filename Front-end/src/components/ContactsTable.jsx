...
const ContactsTable = () => {
    ...
    const handleUpdateSubmit = async () => {
        ...
        try {
            ...
            setContacts((prev) =>
                prev.map((c) => (c._id === data._id ? { ...c, ...data } : c))
            );
            toast({
    ...
    return (
        <Box p={6} borderWidth="1px" borderRadius="md" bg={bgColor} shadow="0 1px 3px rgba(0,0,0,0.05)" borderColor={borderColor}>
                        ...
                        <Tbody>
                            {getFilteredContacts().map((contact) => (
                                ...
                                >
                                    ...
                                    <Td color={textColor} fontSize="sm">{contact.notes || "-"}</Td>
                                    <Td>
