...
const JobsTable = () => {
  ...
  const {
    ...
    onOpen: onDescModalOpen,
    onClose: onDescModalClose,
  } = useDisclosure();
  const {
  ...
  const {
    ...
    onOpen: onSendMailAlertOpen,
    onClose: onSendMailAlertClose,
  } = useDisclosure();
  const [descriptionModalJob, setDescriptionModalJob] =
    React.useState(null);
  ...
  const [deleteLoading, setDeleteLoading] =
    React.useState(false);
  const [sendMailLoading, setSendMailLoading] =
    React.useState(false);
  const [sendingSingleMailId, setSendingSingleMailId] =
    React.useState(null);
    ...
    <>
      <VStack spacing={8} align="stretch">
          ...
          <form onSubmit={handleSubmit}>
            <Stack spacing={4}>
              ...
              >
                ...
                />
                <FormHelperText mb={0}>
                  When on, this job is picked when cron
                  runs.
                </FormHelperText>
              </FormControl>
                ...
                <Tbody>
                  {getFilteredJobs().map((job) => (
                    ...
                    >
                      <Td>
                        <Tooltip
                          label="Click to view description"
                          placement="top"
                          hasArrow
                        >
                          <Text
        ...
        >
          ...
          <ModalContent>
            <ModalHeader>
              {descriptionModalJob?.job ?? "Description"}
            </ModalHeader>
            <ModalCloseButton />
            <ModalBody>
              <Text whiteSpace="pre-wrap">
                {descriptionModalJob?.description ||
                  "No description."}
              </Text>
            </ModalBody>
            <ModalFooter>
              <Button
                ...
                onClick={() => {
                  onDescModalClose();
                  if (descriptionModalJob)
                    openUpdateModal(descriptionModalJob);
                }}
        ...
        >
          <AlertDialogOverlay>
            <AlertDialogContent>
              ...
              <AlertDialogBody>
                Are you sure you want to send emails to all{" "}
                {jobs.length} jobs? This will send an email
                to each recruiter.
              </AlertDialogBody>
