...
import { ChevronUpIcon, ChevronDownIcon, SearchIcon, EditIcon, DeleteIcon, EmailIcon, PhoneIcon } from "@chakra-ui/icons";
...
const JobsTable = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setNewJob({ job: "", email: "", description: "", number: "", recuiterName: "", city: "", includeInCron: true });
            fetchJobs();
            toast({
                ...
                {editForm && (
                  <Stack spacing={4}>
                    ...
                    >
                      ...
                      />
                      <FormHelperText mb={0}>
                        When on, this job is picked when
                        cron runs.
                      </FormHelperText>
                    </FormControl>
                  </Stack>
            ...
            <AlertDialogOverlay>
              <AlertDialogContent>
                ...
                <AlertDialogBody>
                  ...
                  all {jobs.length} jobs? This will send an
                  email to each recruiter.
                </AlertDialogBody>
