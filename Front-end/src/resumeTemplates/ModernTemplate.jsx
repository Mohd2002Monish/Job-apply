...
const ModernTemplate = ({ resumeData = {}, onUpdate, editMode = true, theme: rawTheme }) => {
  ...
  const addEdu = () => onUpdate?.({ education: [{ institution: 'University', degree: 'Bachelor', field: '', startDate: '', endDate: '', gpa: '' }, ...(resumeData.education || [])] });
  ...
  const addPr = () => onUpdate?.({ projects: [{ name: 'New Project', description: '', techStack: [], url: '' }, ...(resumeData.projects || [])] });
